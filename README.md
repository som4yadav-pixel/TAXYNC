...
**🎯 New: Personal Tax Consultant** - It is now a Personal Tax Consultant in app form—helping you decide not just which regime to pick, but how to change your investment behavior to pay the least amount of tax legally possible.
...
- Python (v3.9 or newer). On Windows you can install Python 3.11 with `winget install --id Python.Python.3.11 -e`.
- `pip` and `virtualenv`
...
1.  **Start the Backend Server:**
    ...
    > **Note:** The API returns `optimization_suggestions`; the frontend now automatically maps them to display "Tax Optimization Suggestions" cards.
