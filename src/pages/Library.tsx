...
export function Library() {
  ...
  const taxLaws = [
    ...
    },
    {
      id: 9,
      section: '80U',
      title: 'Disability Deduction',
      description: 'Flat deduction for certified disability under the Persons with Disabilities Act.',
      simpleExplanation: 'If you have a certified disability, get a flat deduction. Standard: ₹75,000, Severe: ₹1,25,000 tax saving.',
    ...
    },
    {
      id: 10,
      section: '80QQB',
      title: 'Royalty Income (Authors)',
      description: 'Deduction for royalty income received by authors on their books.',
      simpleExplanation: 'Are you an author? Royalty income up to ₹3,00,000 is tax-deductible. Maximum tax saving: ₹93,000.',
      limit: '₹3,00,000',
      category: 'Specialized Income',
      icon: BookOpen,
      color: 'bg-amber-500',
      officialLink: 'https://www.incometax.gov.in/iec/foportal/help/individual/return-applicable-forms-and-instructions/itr-1/deductions-under-chapter-vi-a',
      isAdvanced: true
    },
    {
      id: 11,
      section: '80RRB',
      title: 'Royalty Income (Patents)',
      description: 'Deduction for royalty income on registered patents.',
      simpleExplanation: 'Have a patented invention? Royalty income up to ₹3,00,000 gets tax deduction. Maximum saving: ₹93,000.',
      limit: '₹3,00,000',
      category: 'Specialized Income',
      icon: BookOpen,
      color: 'bg-yellow-500',
    ...
    },
    {
      ...
      description: 'Deduction for donations made to political parties via digital/cheque payments.',
      simpleExplanation: 'Donate to political parties digitally or by cheque. 100% of donation is deductible from taxable income.',
    ...
    },
    {
      ...
      description: 'Deduction for interest paid on electric vehicle loans sanctioned between 2019-2023.',
      simpleExplanation: 'Took loan for electric vehicle? Interest up to ₹1,50,000 can save tax. Maximum saving: ₹46,500 per year.',
      limit: '₹1,50,000',
      category: 'Green Incentives',
      icon: Home,
      color: 'bg-green-600',
      officialLink: 'https://www.incometax.gov.in/iec/foportal/help/individual/return-applicable-forms-and-instructions/itr-1/deductions-under-chapter-vi-a',
      isAdvanced: true
  ...
  const categories = ['All', 'Investment', 'Health', 'Housing', 'Education', 'Charity', 'Relief', 'Specialized Income', 'Others', 'Green Incentives'];
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {law.isAdvanced && (
                        <span className="bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 px-2 py-1 rounded-full text-xs font-medium">
                          Advanced
                        </span>
                      )}
                    </div>
